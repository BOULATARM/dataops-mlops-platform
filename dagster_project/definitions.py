"""
Point d'entrée Dagster — objet Definitions assemblant tout.

Variable d'environnement DAGSTER_HOME n'est pas requise pour le dev local.
La variable DUCKDB_PATH est passée explicitement dans chaque asset/subprocess.
"""
...
from dagster_project.resources.duckdb_resource import build_duckdb_resource
