"""
LEGACY / DÉPRÉCIÉ : utiliser python -m ml.training.train_v2.
Entraînement historique : features numériques → LogisticRegression.
...
if __name__ == "__main__":
    raise SystemExit("Deprecated: use python -m ml.training.train_v2")
